...
$class = isset( $class ) ? $class : 'mwb-plugin-fw-text-input';
?>
<input type="text" name="<?php echo $name ?>"
    ...
    <?php if ( !$backward_compatibility && isset( $data ) ) echo mwb_plugin_fw_html_data_to_string( $data ); ?>/>
...
if ( isset( $buttons ) ) {
    ...
    mwb_plugin_fw_get_field( $button_field, true );
}
?>
