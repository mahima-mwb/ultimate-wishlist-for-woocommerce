...
$class = !empty( $class ) ? $class : 'mwb-plugin-fw-multi-colorpicker';
?>
...
?>
    <div class="mwb-colorpicker-group">
        <?php
        ...
        ?>
        <div class="mwb-single-colorpicker colorpicker">
            <label for="<?php echo esc_attr($colorpicker['id']  )?>"><?php echo esc_html($colorpicker['title']) ?></label>
            <?php echo mwb_plugin_fw_get_field( $colorpicker, true, false ); ?>
            </div>
