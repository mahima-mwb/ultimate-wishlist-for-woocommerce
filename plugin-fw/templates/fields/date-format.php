...
$class = 'mwb-plugin-fw-radio ' . $class;

$options = mwb_get_date_format( $js );
$custom  = true;
?>
<div class="<?php echo $class ?> mwb-plugin-fw-date-format" id="<?php echo $id ?>"
	<?php echo $custom_attributes ?>
	<?php if ( isset( $data ) ) {
		echo mwb_plugin_fw_html_data_to_string( $data );
	...
	<?php foreach ( $options as $key => $label ) :
		...
		?>
        <div class="mwb-plugin-fw-radio__row">
    ...
    <div class="mwb-plugin-fw-radio__row">
        ...
        <label for="<?php echo esc_attr( $radio_id ) ?>"> <?php _e( 'Custom:', 'mwb-plugin-fw' ) ?></label>
