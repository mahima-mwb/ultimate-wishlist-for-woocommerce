...
$extra_row_classes = apply_filters( 'mwb_plugin_fw_panel_wc_extra_row_classes', $extra_row_classes, $field );
$extra_row_classes = is_array( $extra_row_classes ) ? implode( ' ', $extra_row_classes ) : '';

?>
<tr valign="top" class="mwb-plugin-fw-panel-wc-row <?php echo $field[ 'type' ] ?> <?php echo $extra_row_classes ?>" <?php echo mwb_field_deps_data( $field ) ?>>
    <?php if ( $display_row ) : ?>
