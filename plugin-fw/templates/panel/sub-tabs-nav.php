...
<?php if ( !empty( $sub_tabs ) ): ?>
    <div class="mwb-plugin-fw-sub-tabs-nav">
        <h3 class="nav-tab-wrapper mwb-nav-sub-tab-wrapper">
            <?php foreach ( $sub_tabs as $_key => $_tab ):
                ...
                ?>
                <a href="<?php echo $_tab->url ?>" class="mwb-nav-sub-tab nav-tab <?php echo $_tab->class ?>">
                    <span class="mwb-nav-sub-tab__title"><?php echo $_tab->title; ?></span>
                    <?php if ( $_tab->icon ) : ?>
                        <span class="mwb-nav-sub-tab__icon mwb-icon-<?php echo $_tab->icon ?>"></span>
                    <?php endif; ?>
                </a>
            <?php endforeach; ?>
        </h3>
