...
if ( ! class_exists( 'mwb_Plugin_Common' ) ) :
...
class mwb_Plugin_Common {
    ...
    public function init() {
        self::$_config['header_backgrounds'] = apply_filters( 'mwb_header_backgrounds', self::$_config['header_backgrounds'] );
        self::$_config['body_backgrounds']   = apply_filters( 'mwb_body_backgrounds', self::$_config['body_backgrounds'] );
    }
    ...
    public static function get_icon_list() {
        ...
        return apply_filters( 'mwb_icon_list', $standard_icon_list );
    }
