 ...
 * @author     Your Inspiration Themes Team <info@mwbemes.com>
 *
...
if ( ! class_exists( 'mwb_Gradients' ) ) {
    ...
    class mwb_Gradients {
        ...
        public function getModel( $class ) {
            return mwb_Registry::get_instance()->$class;
        }
        ...
        public function __get( $name ) {
            if ( $name == 'request' ) {
                if ( ! $this->_request instanceof mwb_Request ) {
                    $this->_request = mwb_Registry::get_instance()->request;
                }
