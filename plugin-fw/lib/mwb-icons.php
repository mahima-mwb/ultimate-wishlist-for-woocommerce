    ...
    class mwb_Icons {
        ...
        public function get_icons( $filter_icons = '' ) {
            ...
            if ( !empty( $filter_icons ) ) {
                $icons = apply_filters( 'mwb_plugin_fw_icons_field_icons_' . sanitize_key( $filter_icons ), $icons );
            }
        ...
        private function _get_font_awesome_array() {
            $font_awesome_list    = get_option( 'mwb_font_awesome_list', array() );
            ...
            if ( !empty( $font_awesome_list[ $font_awesome_version ] ) ) {
                ...
                update_option( 'mwb_font_awesome_list', $font_awesome_list );
            }
        ...
        private function _get_dashicons_array() {
            $dashicons_list = get_option( 'mwb_dashicons_list', array() );
...
if( ! function_exists( 'mwb_Icons' ) ){
	function mwb_Icons() {
		return mwb_Icons::get_instance();
	}
}
