...
( function ( $ ) {
    ...
    $( act_page_option ).insertAfter( '#mwb-post-setting .handlediv' );
    $( act_page_option ).insertAfter( '#mwb-page-setting .handlediv' );


    $( '#_active_page_options-container' ).on( 'click', function () {
        if ( $( '#_active_page_options' ).is( ":checked" ) ) {
            $( '#mwb-page-setting .inside .metaboxes-tab, #mwb-post-setting .inside .metaboxes-tab' ).css( {
                                                                                                               'opacity'       : 1,
                                                                                                               'pointer-events': 'auto'
                                                                                                           } );
        } else {
    ...
    $( document.body ).on( 'mwb-plugin-fw-metabox-init-deps', function () {
        $( document.body ).trigger( 'mwb-plugin-fw-init-radio' );
        $( '.metaboxes-tab [data-dep-target]:not(.mwb-plugin-fw-metabox-deps-initialized)' ).each( function () {
            var t = $( this );
            ...
            t.addClass( 'mwb-plugin-fw-metabox-deps-initialized' );
        } );
    } ).trigger( 'mwb-plugin-fw-metabox-init-deps' );
