=== mwb WooCommerce Wishlist ===

Contributors: mwbemes
Tags: wishlist, woocommerce, products, mwb, e-commerce, shop, ecommerce wishlist, mwb, woocommerce wishlist, shop wishlist
...
mwb WooCommerce Wishlist add all Wishlist features to your website. Needs WooCommerce to work.
...
3. Activate `mwb WooCommerce Wishlist` from Plugins page

mwb WooCommerce Wishlist will add a new submenu called "Wishlist" under "mwb Plugins" menu. Here you are able to configure all the plugin settings.
...
* Fix: issue with cart redirect when using mwb WCCL
...
* Dev: added new filter mwb_wcwl_fragments_index_glue
...
* Fix: correctly applied mwb_wcwl_is_wishlist_responsive filter to mwb_wcwl_is_mobile function
...
* Dev: added mwb_wcwl_add_to_wishlist_icon_html filter
* Dev: added mwb_wcwl_add_to_wishlist_heading_icon_html filter
* Dev: added mwb_wcwl_add_to_wishlist_data trigger, to allow third party code change data submitted with ATW ajax call
...
* Dev: added mwb_wcwl_is_wishlist_responsive filter, to allow developers disable responsive behaviour for the wishlist
* Dev: added mwb_wcwl_generated_default_wishlist action
* Dev: added mwb_wcwl_default_wishlist filter
* Dev: added mwb_wcwl_add_notice wrapper function, to avoid possible fatal errors when calling wc_add_notice
...
* Fix: compatibility with mwb Infinite Scrolling when ajax loading is enabled
...
* Dev: added mwb_wcwl_reload_fragments trigger to refresh wishlist fragments
* Dev: added mwb_wcwl_remove_hidden_products_via_query filter
* Dev: added mwb_wcwl_show_add_to_wishlist filter, to allow dev selectively hide Add to Wishlist buttons
...
* Fix: returning correct wishlist and user id to mwb_wcwl_added_to_wishlist and mwb_wcwl_removed_from_wishlist actions (thanks to danielbitzer)
* Fix: issue with default value for mwb_wcwl_positions option
* Fix: added key name to avoid DB error during install or update procedure
* Dev: added mwb_wcwl_shortcode_share_link_url filter
...
* Dev: added mwb_wcwl_wishlist_delete_url filter

= 3.0.3 - Released on 12 December 2019 =

* Tweak: prevent mwb_setcookie to process if cookie name is not set
...
* Update: plugin framework
* Tweak: added defaults for mwb_wcwl_add_to_cart_text option (thanks to ecksiteweb)
* Fix: prevent fatal error when switching from cookies to session

= 3.0.1 - Released on 10 December 2019 =

* Update: language files
* Tweak: restored global $mwb_wcwl
...
* Dev: new mwb_WCWL_Wishlist and mwb_WCWL_Wishlist_Item objects
* Dev: now using Data_store classes to handle db operations
* Dev: added filter mwb_wcwl_loop_positions
* Dev: added filter mwb_wcwl_custom_css_rules
* Dev: added filter mwb_wcwl_session_cookie
* Dev: added filter mwb_wcwl_item_formatted_price
* Dev: added filter mwb_wcwl_wishlist_formatted_title
* Dev: added filter mwb_wcwl_wishlist_get_items
* Dev: added filter mwb_wcwl_user_cannot_add_to_wishlist_message
* Dev: added filter mwb_wcwl_can_user_add_to_wishlist
* Dev: added filters mwb_wcwl_add_wishlist_{property}
* Dev: added filters mwb_wcwl_adding_to_wishlist_{property}
...
* Dev: added new mwb_wcwl_product_already_in_wishlist_text_button and mwb_wcwl_product_added_to_wishlist_message_button filters
* Dev: added new mwb_wcwl_out_of_stock_label and mwb_wcwl_in_stock_label filters
...
* Dev: add filter mwb_wcwl_wishlist_correctly_created on add_wishlist function

= 2.2.11 - Released on 13 June 2019 =

* Update: internal plugin framework
* Tweak: Prevent undefined index user_id when user is logging
* Dev: New action mwb_wcwl_default_user_wishlist
...
* Dev: add filter mwb_wcwl_email_share_subject
...
* Dev: added product param to mwb_free_text filter
...
* Update: Spanish language
* Update: Italian language
* Dev: added new filter mwb_wcwl_localize_script to let third party dev filter localization variables
* Dev: added new filter mwb_wcwl_share_conditions to display the share buttons for no logged users
* Dev: added new filter mwb_wcwl_set_cookie to let third party code skip cookie saving
* Dev: added new filter mwb_wcwl_wishlist_param to change query-string param
* Dev: added new filter mwb_wcwl_remove_product_wishlist_message_title
...
* Dev: added mwb_wcwl_removing_from_wishlist / mwb_wcwl_removed_from_wishlist hooks
...
* Dev: action as second param for mwb_wcwl_wishlist_page_url filter
* Dev: applied filter mwb_wcwl_no_product_to_remove_message also for message on wishlist-view template
* Dev: added filter mwb_wcwl_add_wishlist_user_id
* Dev: added filter mwb_wcwl_add_wishlist_slug
...
* Added: filter mwb_wcwl_is_product_in_wishlist to choose whether a product is in wishlist or not
* Added: filter mwb_wcwl_cookie_expiration to set default wishlist cookie expiration time in seconds
* Tweak: updated plugin-fw
...
* Added: mwb_wcwl_is_wishlist_page function to identify if current page is wishlist page
* Added: filter mwb_wcwl_settings_panel_capability for panel capability
* Added: filter mwb_wcwl_current_wishlist_view_params for shortcode view params
* Added: "defined mwb_WCWL" check before every template
* Added: check over existance of $.prettyPhoto.close before using it
* Added: method count_add_to_wishlist to mwb_WCWL class
* Added: function mwb_wcwl_count_add_to_wishlist
* Tweak: Changed ajax url to "relative"
* Tweak: Removed mwb-common (old plugin-fw) deprecated since 2.0
...
* Fixed: typo in hook mwb_wccl_table_after_product_name (now set to mwb_wcwl_table_after_product_name)
...
* Added: 'mwb_wcwl_added_to_cart_message' filter, to customize added to cart message in wishlist page
* Added: nofollow to "Add to Wishlist" links, where missing
* Added: 'mwb_wcwl_email_share_subject' filter to customize share by email subject
* Added: 'mwb_wcwl_email_share_body' filter to customize share by email body
* Added: function "mwb_wcwl_count_all_products"
* Fixed: plugin-fw loading

= 2.0.12 - Released on 23 October 2015 =

* Added: method to count all products in wishlist
* Tweak: Added wishlist js handling on 'mwb_wcwl_init' triggered on document
...
* Updated: changed text domain from mwb to mwb-woocommerce-wishlist
...
* Tweak: added mwb_wcwl_custom_add_to_cart_text and mwb_wcwl_ask_an_estimate_text filters
...
* Fixed: icon attribute for mwb_wcwl_add_to_wishlist shortcode
...
* Tweak: moved WC notices from wishlist template to mwb_wcwl_before_wishlist_title hook
* Tweak: added wishlist table id to .load(), to update only that part of template
* Fixed: mwb_wcwl_locate_template causing 500 Internal Server Error
...
* Added: Support to WooCommerce Endpoints (@use mwb_wcwl_add_to_cart_redirect_url filter)
...
* Fixed: Fatal error to mwb_debug with mwb themes
