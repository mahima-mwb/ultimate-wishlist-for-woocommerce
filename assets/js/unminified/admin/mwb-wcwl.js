/**
 * Admin mwb WooCommerce Wishlist JS
 *
 * @author mwb
...
jQuery( document ).ready( function( $ ) {
    ...
    $.fn.dependency = function (deps, test, complete, args) {
        ...
        t.on('change', function () {
            ...
            $.each(deps, function (i, v) {
                ...
                // val ? target.removeClass('mwb-disabled') : target.addClass('mwb-disabled');
            });
    ...
    var Wizard = function( el, args ){
            ...
            self._init = function(){
                self.settings = $.extend( {
                    ...
                    template_data: {},
                    container: '.mwb-wcwl-wizard-modal',
                    events: {}
                }, args );
        ...
        getPromotionWizardData = function(){
            return {
                template: 'mwb-wcwl-promotion-wizard',
    ...
    var disable_wishlist_for_unauthenticated_users = $('#mwb_wcwl_disable_wishlist_for_unauthenticated_users'),
        multi_wishlist_enable = $('#mwb_wcwl_multi_wishlist_enable'),
        enable_multi_wishlist_for_unauthenticated_users = $('#mwb_wcwl_enable_multi_wishlist_for_unauthenticated_users'),
        modal_enable = $('#mwb_wcwl_modal_enable'),
        loop_position = $('#mwb_wcwl_loop_position'),
        icon_select = $('.icon-select'),
        add_to_cart_style = $('[name="mwb_wcwl_add_to_cart_style"]'),
        add_to_cart_icon = $('#mwb_wcwl_add_to_cart_icon'),
        ask_an_estimate_style = $('[name="mwb_wcwl_ask_an_estimate_style"]'),
        ask_an_estimate_icon = $('#mwb_wcwl_ask_an_estimate_icon'),
        enable_share = $('#mwb_wcwl_enable_share'),
        share_facebook = $('#mwb_wcwl_share_fb'),
        share_facebook_icon = $('#mwb_wcwl_fb_button_icon'),
        share_twitter = $('#mwb_wcwl_share_twitter'),
        share_twitter_icon = $('#mwb_wcwl_tw_button_icon'),
        share_pinterest = $('#mwb_wcwl_share_pinterest'),
        share_pinterest_icon = $('#mwb_wcwl_pr_button_icon'),
        share_email = $('#mwb_wcwl_share_email'),
        share_email_icon = $('#mwb_wcwl_em_button_icon'),
        share_whatsapp = $('#mwb_wcwl_share_whatsapp'),
        share_whatsapp_icon = $('#mwb_wcwl_wa_button_icon'),
        show_estimate_button = $('#mwb_wcwl_show_estimate_button'),
        show_additional_info_textarea = $('#mwb_wcwl_show_additional_info_textarea'),
        ask_an_estimate_fields = $('#mwb_wcwl_ask_an_estimate_fields'),
        promotion_mail_type = $('#woocommerce_promotion_mail_settings\\[email_type\\]'),
        back_in_stock_mail_enabled = $('#woocommerce_mwb_wcwl_back_in_stock_settings\\[enabled\\]'),
        back_in_stock_mail_type = $('#woocommerce_mwb_wcwl_back_in_stock_settings\\[email_type\\]'),
        on_sale_item_mail_enabled = $('#woocommerce_mwb_wcwl_on_sale_item_settings\\[enabled\\]'),
        on_sale_item_mail_type = $('#woocommerce_mwb_wcwl_on_sale_item_settings\\[email_type\\]'),
        ask_an_estimate_type = $('[id^="type_"]');

    loop_position.add('select#mwb_wcwl_button_position').on('change', function () {
        var t = $(this),
            v = t.val();
    ...
    ask_an_estimate_type.on( 'change', function(){
        var t = $(this),
            v = t.val(),
            options_field = t.closest( '.mwb-toggle-content-row' ).next();
    ...
    disable_wishlist_for_unauthenticated_users.dependency([
        '#mwb_wcwl_enable_multi_wishlist_for_unauthenticated_users-yes'
    ], function(){
    ...
    enable_multi_wishlist_for_unauthenticated_users.dependency([
        '#mwb_wcwl_show_login_notice',
        '#mwb_wcwl_login_anchor_text'
    ], function(){
    ...
    modal_enable.dependency([
        '#mwb_wcwl_show_exists_in_a_wishlist'
    ], function(){
        var res = modal_enable.find( ':checked' ).val() !== 'default';

        if( ! res ){
            $('#mwb_wcwl_show_exists_in_a_wishlist').prop( 'checked', true );
        }
    ...
    share_facebook.dependency([
        '#mwb_wcwl_fb_button_icon',
        '#mwb_wcwl_color_fb_button_background'
    ], function(){
    ...
    share_twitter_icon.dependency([
        '#mwb_wcwl_tw_button_custom_icon'
    ], function(){
        return isChecked( share_twitter ) && isChecked( enable_share ) && 'custom' === share_twitter_icon.val();
    } );

    share_pinterest.dependency([
        '#mwb_wcwl_socials_image_url',
        '#mwb_wcwl_pr_button_icon',
        '#mwb_wcwl_color_pr_button_background'
    ], function(){
    ...
    share_email_icon.dependency([
        '#mwb_wcwl_em_button_custom_icon'
    ], function(){
        return isChecked( share_email ) && isChecked( enable_share ) && 'custom' === share_email_icon.val();
    } );

    share_whatsapp.dependency([
        '#mwb_wcwl_wa_button_icon',
        '#mwb_wcwl_wa_button_custom_icon',
        '#mwb_wcwl_color_wa_button_background'
    ], function(){
    ...
    show_additional_info_textarea.dependency([
        '#mwb_wcwl_additional_info_textarea_label'
    ], function(){
    ...
    show_additional_info_textarea.on( 'change', function(){
        ...
        if( t.is(':checked') && show_estimate_button.is(':checked') ){
            ask_an_estimate_fields.removeClass( 'mwb-disabled' );
        }
        else {
            ask_an_estimate_fields.addClass( 'mwb-disabled' );
        }
    } );
    ...
    back_in_stock_mail_enabled.dependency([
        '#woocommerce_mwb_wcwl_back_in_stock_settings\\[product_exclusions\\]',
        '#woocommerce_mwb_wcwl_back_in_stock_settings\\[category_exclusions\\]',
        '#woocommerce_mwb_wcwl_back_in_stock_settings\\[email_type\\]',
        '#woocommerce_mwb_wcwl_back_in_stock_settings\\[heading\\]',
        '#woocommerce_mwb_wcwl_back_in_stock_settings\\[subject\\]',
        '#woocommerce_mwb_wcwl_back_in_stock_settings\\[content_html\\]',
        '#woocommerce_mwb_wcwl_back_in_stock_settings\\[content_text\\]'
    ], function(){
    ...
    on_sale_item_mail_enabled.dependency([
        '#woocommerce_mwb_wcwl_on_sale_item_settings\\[product_exclusions\\]',
        '#woocommerce_mwb_wcwl_on_sale_item_settings\\[category_exclusions\\]',
        '#woocommerce_mwb_wcwl_on_sale_item_settings\\[email_type\\]',
        '#woocommerce_mwb_wcwl_on_sale_item_settings\\[heading\\]',
        '#woocommerce_mwb_wcwl_on_sale_item_settings\\[subject\\]',
        '#woocommerce_mwb_wcwl_on_sale_item_settings\\[content_html\\]',
        '#woocommerce_mwb_wcwl_on_sale_item_settings\\[content_text\\]'
    ], function(){
    ...
    $(document).on( 'mwb-add-box-button-toggle', function(){
        var ask_an_estimate_type_new = $('#new_type'),
            ask_an_estimate_options_new = $('#new_options'),
            target = ask_an_estimate_options_new.closest('.mwb-add-box-row');
