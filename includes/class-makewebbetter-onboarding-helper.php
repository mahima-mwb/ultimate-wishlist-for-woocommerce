...
class Makewebbetter_Onboarding_Helper {
	...
	public function add_onboarding_popup_screen() {
		...
		if ( $this->is_valid_page_screen() && $this->can_show_onboarding_popup() ) {
			require_once WISHLIST_PLUGINS_PATH . 'extra-templates/makewebbetter-onboarding-template-display.php';
		}
	}
	...
	public function add_deactivation_popup_screen() {
		...
		if ( ! empty( $pagenow ) && 'plugins.php' == $pagenow ) {
			require_once WISHLIST_PLUGINS_PATH . 'extra-templates/makewebbetter-deactivation-template-display.php';
		}
	}
	 ...
	 *
	 * @param bool   $submission Bool value to check form submission.
