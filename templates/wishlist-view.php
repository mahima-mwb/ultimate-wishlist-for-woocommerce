 ...
 * Template variables:
 *
 * @var $wishlist                      \mwb_WCWL_Wishlist Current wishlist
...
<table
	...
	<tr>
		...
		<?php if ( $show_remove_product ) : ?>
			...
			<th class="product-remove">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'mwb_wcwl_wishlist_view_remove_heading', '', $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
		...
		<th class="product-name">
			<span class="nobr">
				<?php echo esc_html( apply_filters( 'mwb_wcwl_wishlist_view_name_heading', __( 'Product name', 'mwb-woocommerce-wishlist' ), $wishlist ) ); ?>
			</span>
		</th>
		...
		<?php if ( $show_price || $show_price_variations ) : ?>
			...
			<th class="product-price">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'mwb_wcwl_wishlist_view_price_heading', __( 'Unit price', 'mwb-woocommerce-wishlist' ), $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
		...
		<?php if ( $show_quantity ) : ?>
			...
			<th class="product-quantity">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'mwb_wcwl_wishlist_view_quantity_heading', __( 'Quantity', 'mwb-woocommerce-wishlist' ), $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
		...
		<?php if ( $show_stock_status ) : ?>
			...
			<th class="product-stock-status">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'mwb_wcwl_wishlist_view_stock_heading', __( 'Stock status', 'mwb-woocommerce-wishlist' ), $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
		...
		<?php if ( $show_last_column ) : ?>
			...
			<th class="product-add-to-cart">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'mwb_wcwl_wishlist_view_cart_heading', '', $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
		...
		<?php if ( $enable_drag_n_drop ) : ?>
			...
			<th class="product-arrange">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'mwb_wcwl_wishlist_view_arrange_heading', __( 'Arrange', 'mwb-woocommerce-wishlist' ), $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
	</tr>
	...
	if ( $wishlist && $wishlist->has_items() ) :
		foreach ( $wishlist_items as $item ) :
			...
			/**
			 * @var $item \mwb_WCWL_Wishlist_Item
			 */
			global $product;
			...
			if ( $product && $product->exists() ) :
				?>
				<tr id="mwb-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					<?php if ( $show_cb ) : ?>
					...
					<?php if ( $show_remove_product ) : ?>
						<td class="product-remove">
							<div>
								<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove remove_from_wishlist" title="<?php echo esc_html( apply_filters( 'mwb_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'mwb-woocommerce-wishlist' ) ) ); ?>">&times;</a>
							</div>
						</td>
					<?php endif; ?>

					<td class="product-thumbnail">
						<?php do_action( 'mwb_wcwl_table_before_product_thumbnail', $item, $wishlist ); ?>

						<a href="<?php echo esc_url( get_permalink( apply_filters( 'woocommerce_in_cart_product', $item->get_product_id() ) ) ); ?>">
							<?php echo $product->get_image(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</a>

						<?php do_action( 'mwb_wcwl_table_after_product_thumbnail', $item, $wishlist ); ?>
					</td>

					<td class="product-name">
						<?php do_action( 'mwb_wcwl_table_before_product_name', $item, $wishlist ); ?>
						...
						<?php do_action( 'mwb_wcwl_table_after_product_name', $item, $wishlist ); ?>
					</td>

					<?php if ( $show_price || $show_price_variations ) : ?>
						<td class="product-price">
							<?php do_action( 'mwb_wcwl_table_before_product_price', $item, $wishlist ); ?>
							...
							<?php do_action( 'mwb_wcwl_table_after_product_price', $item, $wishlist ); ?>
						</td>
					<?php endif ?>

					<?php if ( $show_quantity ) : ?>
						<td class="product-quantity">
							<?php do_action( 'mwb_wcwl_table_before_product_quantity', $item, $wishlist ); ?>
							...
							<?php do_action( 'mwb_wcwl_table_after_product_quantity', $item, $wishlist ); ?>
						</td>
					<?php endif; ?>

					<?php if ( $show_stock_status ) : ?>
						<td class="product-stock-status">
							<?php do_action( 'mwb_wcwl_table_before_product_stock', $item, $wishlist ); ?>

							<?php echo 'out-of-stock' === $stock_status ? '<span class="wishlist-out-of-stock">' . esc_html( apply_filters( 'mwb_wcwl_out_of_stock_label', __( 'Out of stock', 'mwb-woocommerce-wishlist' ) ) ) . '</span>' : '<span class="wishlist-in-stock">' . esc_html( apply_filters( 'mwb_wcwl_in_stock_label', __( 'In Stock', 'mwb-woocommerce-wishlist' ) ) ) . '</span>'; ?>

							<?php do_action( 'mwb_wcwl_table_after_product_stock', $item, $wishlist ); ?>
						</td>
					<?php endif ?>

					<?php if ( $show_last_column ) : ?>
						<td class="product-add-to-cart">
							<?php do_action( 'mwb_wcwl_table_before_product_cart', $item, $wishlist ); ?>

							<!-- Date added -->
							<?php
							if ( $show_dateadded && $item->get_date_added() ) :
								// translators: date added label: 1 date added.
								echo '<span class="dateadded">' . esc_html( sprintf( __( 'Added on: %s', 'mwb-woocommerce-wishlist' ), $item->get_date_added_formatted() ) ) . '</span>';
							endif;
							?>

							<?php do_action( 'mwb_wcwl_table_product_before_add_to_cart', $item, $wishlist ); ?>

							<!-- Add to cart button -->
							<?php $show_add_to_cart = apply_filters( 'mwb_wcwl_table_product_show_add_to_cart', $show_add_to_cart, $item, $wishlist ); ?>
							...
							<?php do_action( 'mwb_wcwl_table_product_after_add_to_cart', $item, $wishlist ); ?>

							<!-- Change wishlist -->
							<?php $move_to_another_wishlist = apply_filters( 'mwb_wcwl_table_product_move_to_another_wishlist', $move_to_another_wishlist, $item, $wishlist ); ?>
							<?php if ( $move_to_another_wishlist && $available_multi_wishlist && count( $users_wishlists ) > 1 ) : ?>
								<?php if ( 'select' === $move_to_another_wishlist_type ) : ?>
									<select class="change-wishlist selectBox">
										<option value=""><?php esc_html_e( 'Move', 'mwb-woocommerce-wishlist' ); ?></option>
										<?php
										foreach ( $users_wishlists as $wl ) :
											// phpcs:ignore Generic.Commenting.DocComment
											/**
											 * @var $wl \mwb_WCWL_Wishlist
											 */
								...
								<?php else : ?>
									<a href="#move_to_another_wishlist" class="move-to-another-wishlist-button" data-rel="prettyPhoto[move_to_another_wishlist]">
										<?php echo esc_html( apply_filters( 'mwb_wcwl_move_to_another_list_label', __( 'Move to another list &rsaquo;', 'mwb-woocommerce-wishlist' ) ) ); ?>
									</a>
								<?php endif; ?>

								<?php do_action( 'mwb_wcwl_table_product_after_move_to_another_wishlist', $item, $wishlist ); ?>

							<?php endif; ?>

							<!-- Remove from wishlist -->
							<?php if ( $repeat_remove_button ) : ?>
								<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove_from_wishlist button" title="<?php echo esc_html( apply_filters( 'mwb_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'mwb-woocommerce-wishlist' ) ) ); ?>"><?php esc_html_e( 'Remove', 'mwb-woocommerce-wishlist' ); ?></a>
							<?php endif; ?>

							<?php do_action( 'mwb_wcwl_table_after_product_cart', $item, $wishlist ); ?>
						</td>
					<?php endif; ?>
	...
	?>
		<tr>
			<td colspan="<?php echo esc_attr( $column_count ); ?>" class="wishlist-empty"><?php echo esc_html( apply_filters( 'mwb_wcwl_no_product_to_remove_message', __( 'No products added to the wishlist', 'mwb-woocommerce-wishlist' ), $wishlist ) ); ?></td>
		</tr>
	<?php
	endif;
