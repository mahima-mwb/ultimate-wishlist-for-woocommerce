	...
	if ( $wishlist && $wishlist->has_items() ) :
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				?>
				<li id="mwb-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					<?php if ( $show_cb ) : ?>
					...
					<div class="item-wrapper">
						...
						<div class="item-details">
							<div class="product-name">
								...
								<?php do_action( 'mwb_wcwl_table_after_product_name', $item ); ?>
							</div>
							...
							<?php if ( $show_variation || $show_dateadded || $show_price ): ?>
								<table class="item-details-table">
									...
									<?php if ( $show_dateadded && $item->get_date_added() ): ?>
										<tr>
											<td class="label">
												<?php esc_html_e( 'Added on:', 'mwb-woocommerce-wishlist' ); ?>
											</td>
											<td class="value">
									...
									<?php if ( $show_price || $show_price_variations ) : ?>
										<tr>
											<td class="label">
												<?php esc_html_e( 'Price:', 'mwb-woocommerce-wishlist' ); ?>
											</td>
											<td class="value">
												<?php
												if ( $show_price ) {
					...
					<div class="additional-info-wrapper">
						<?php if ( $show_quantity || $show_stock_status ): ?>
							<table class="additional-info">
								<?php if ( $show_quantity ) : ?>
									<tr>
										<td class="label">
											<?php esc_html_e( 'Quantity:', 'mwb-woocommerce-wishlist' ); ?>
										</td>
										<td class="value">
								...
								<?php if ( $show_stock_status ) : ?>
									<tr>
										<td class="label">
											<?php esc_html_e( 'Stock:', 'mwb-woocommerce-wishlist' ) ?>
										</td>
										<td class="value">
											<?php echo $stock_status === 'out-of-stock' ? '<span class="wishlist-out-of-stock">' . esc_html__( 'Out of stock', 'mwb-woocommerce-wishlist' ) . '</span>' : '<span class="wishlist-in-stock">' . esc_html__( 'In Stock', 'mwb-woocommerce-wishlist' ) . '</span>'; ?>
										</td>
									</tr>
								<?php endif ?>
							</table>
						...
						<?php if ( $show_remove_product || $repeat_remove_button ): ?>
							<div class="product-remove">
								<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove_from_wishlist" title="<?php echo esc_html( apply_filters( 'mwb_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'mwb-woocommerce-wishlist' ) ) ); ?>"><i class="fa fa-trash"></i></a>
							</div>
						<?php endif; ?>
					</div>
				</li>
		...
		<p class="wishlist-empty">
			<?php echo esc_html( apply_filters( 'mwb_wcwl_no_product_to_remove_message', __( 'No products added to the wishlist', 'mwb-woocommerce-wishlist' ) ) ); ?>
		</p>
	<?php
	endif;
